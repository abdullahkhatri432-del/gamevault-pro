"use strict";(()=>{var e={};e.id=745,e.ids=[745],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2048:e=>{e.exports=require("fs")},5315:e=>{e.exports=require("path")},999:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>d,patchFetch:()=>T,requestAsyncStorage:()=>g,routeModule:()=>m,serverHooks:()=>u,staticGenerationAsyncStorage:()=>l});var a={};r.r(a),r.d(a,{GET:()=>p});var i=r(3278),o=r(5002),n=r(4877),c=r(1309),s=r(1877);async function p(){let e=await (0,s._c)();return c.NextResponse.json(e)}let m=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/store/route",pathname:"/api/store",filename:"route",bundlePath:"app/api/store/route"},resolvedPagePath:"C:\\Users\\abdul\\OneDrive\\Documents\\GitHub\\gamevault-pro\\app\\api\\store\\route.js",nextConfigOutput:"",userland:a}),{requestAsyncStorage:g,staticGenerationAsyncStorage:l,serverHooks:u}=m,d="/api/store/route";function T(){return(0,n.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:l})}},1877:(e,t,r)=>{r.d(t,{fS:()=>w,N_:()=>_,ry:()=>I,Ir:()=>k,tr:()=>y,_c:()=>h,nM:()=>v});let a=require("better-sqlite3");var i=r.n(a),o=r(5315),n=r.n(o),c=r(2048),s=r.n(c);let p=n().join(process.cwd(),"data"),m=n().join(p,"gamevault.db");s().existsSync(p)||s().mkdirSync(p,{recursive:!0});let g=new(i())(m);g.pragma("journal_mode = WAL"),g.exec(`
...
`),R=g.prepare(`
  ...
  WHERE id = @id
`),f=g.prepare("DELETE FROM products WHERE id = @id"),U=g.prepare("SELECT COUNT(*) as count FROM orders"),A=g.prepare("SELECT COALESCE(AVG(CAST(rating AS REAL)), 0) as average FROM reviews");async function h(){let e=T.all(),t=E.all(),r=N.all(),a=U.get().count,i=Number(A.get().average||0);return{featuredAccounts:e,reviews:t,orders:r,stats:{ordersCompleted:a+2400,repeatBuyers:98,averageRating:Number.isFinite(i)?i.toFixed(1):"0.0"}}}async function y(){return T.all()}async function I(e){let t={title:String(e.title||"").trim(),price:String(e.price||"").trim(),tag:String(e.tag||"").trim(),rating:String(e.rating||"4.8").trim(),stock:String(e.stock||"In stock").trim(),category:String(e.category||"Game").trim(),imageUrl:String(e.imageUrl||e.image_url||"").trim(),description:String(e.description||"").trim()};if(!t.title||!t.price||!t.tag)throw Error("Title, price, and tag are required to create a product.");return{id:Number(O.run(t).lastInsertRowid),...t}}async function v(e,t){let r={id:Number(e),title:String(t.title||"").trim(),price:String(t.price||"").trim(),tag:String(t.tag||"").trim(),rating:String(t.rating||"4.8").trim(),stock:String(t.stock||"In stock").trim(),category:String(t.category||"Game").trim(),imageUrl:String(t.imageUrl||t.image_url||"").trim(),description:String(t.description||"").trim()};if(!r.id||!r.title||!r.price||!r.tag)throw Error("A valid product ID, title, price, and tag are required.");return R.run(r),r}async function k(e){return f.run({id:Number(e)}),{deleted:!0,id:Number(e)}}async function w(e){let t={id:Date.now().toString(),name:e.name,email:e.email,game:e.game,note:e.note||"",createdAt:new Date().toISOString()};return L.run(t),t}async function _(e){let t={name:e.name,comment:e.comment,rating:e.rating};return S.run(t),t}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[787,833],()=>r(999));module.exports=a})();