...
const insertOrder = db.prepare(`
  INSERT INTO orders (id, name, email, game, launcher, launcher_id, account_id, account_password, note, amount_paise, coupon_code, discount_paise, status, created_at)
  VALUES (@id, @name, @email, @game, @launcher, @launcherId, @accountId, @accountPassword, @note, @amountPaise, @couponCode, @discountPaise, @status, @createdAt)
`);
