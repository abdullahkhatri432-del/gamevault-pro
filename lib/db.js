...
const seedProducts = [
  ...
  },
  {
    ...
    platform: 'PC',
    launcher: 'Steam, Epic Games, Rockstar Launcher',
    requirements: 'No login needed â€” account credentials delivered after payment',
  ...
  },
  {
    ...
    service_status: 'active',
    fulfillment_method: 'account_login',
    important_notes: 'Do not queue competitive matches during boost. Manual play only â€” no scripts.',
    supported_regions: 'Global',
  },
  {
