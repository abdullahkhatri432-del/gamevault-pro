...
const insertProduct = db.prepare(`
  INSERT OR IGNORE INTO products (title, price, tag, rating, stock, category, game_id, image_url, description)
  VALUES (@title, @price, @tag, @rating, @stock, @category, @game_id, @image_url, @description)
`);
