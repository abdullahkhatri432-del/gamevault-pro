...
const insertProduct = db.prepare(`
  INSERT OR IGNORE INTO products (title, price, tag, rating, stock, category, game_id, image_url, description, platform, launcher, requirements, delivery_time, warranty_days, original_price, service_status, fulfillment_method, important_notes, supported_regions)
  VALUES (@title, @price, @tag, @rating, @stock, @category, @game_id, @image_url, @description, @platform, @launcher, @requirements, @delivery_time, @warranty_days, @original_price, @service_status, @fulfillment_method, @important_notes, @supported_regions)
`);
